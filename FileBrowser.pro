...
UBUNTU_TRANSLATION_DOMAIN="filebrowser.liu-xiao-guo"
...
aptest.commands = bash $$PWD/FileBrowser/tests/autopilot/run
aptest.depends  = sub-FileBrowser

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/FileBrowser/tests/unit
unittest.depends  = sub-FileBrowser
